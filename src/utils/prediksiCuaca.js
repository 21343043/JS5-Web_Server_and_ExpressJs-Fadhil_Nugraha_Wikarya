...
const url = 'http://api.weatherstack.com/current?access_key=1327b26eda7b322ff43c6dd346a8a693&query=' + encodeURIComponent(latitude) + ',' + encodeURIComponent(longitude) + '&units=m';
